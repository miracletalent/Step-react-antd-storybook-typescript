...
import type { WellCO2Emission } from '../models/WellCO2Emission';
...
export class TenantsService {
    ...
    /**
     * Well baseline CO2 emissions
     * @param tenantId
     * @param wellPlannerId
     * @returns WellCO2Emission
     * @throws ApiError
     */
    public static tenantsEmissionsWellsPlannedEmissionsBaselineCo2List(
        tenantId: number,
        wellPlannerId: number,
    ): CancelablePromise<Array<WellCO2Emission>> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/tenants/{tenant_id}/emissions/wells/{well_planner_id}/planned/emissions/baseline/co2/',
            path: {
                'tenant_id': tenantId,
                'well_planner_id': wellPlannerId,
            },
    ...
    /**
     * Well target CO2 emissions
     * @param tenantId
     * @param wellPlannerId
     * @returns WellCO2Emission
     * @throws ApiError
     */
    public static tenantsEmissionsWellsPlannedEmissionsTargetCo2List(
        tenantId: number,
        wellPlannerId: number,
    ): CancelablePromise<Array<WellCO2Emission>> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/tenants/{tenant_id}/emissions/wells/{well_planner_id}/planned/emissions/target/co2/',
            path: {
                'tenant_id': tenantId,
                'well_planner_id': wellPlannerId,
            },
