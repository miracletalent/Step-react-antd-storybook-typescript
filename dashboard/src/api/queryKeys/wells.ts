...
export default {
  ...
  wellPlannedStepCO2(
    ...
    return [
      ...this.wellPlanPlannedEmissions({ tenantId, wellPlanId }),
      '/planned/steps/co2/',
      wellPlanStepId,
    ];
  },
  ...
  wellPlanPlannedEmissions({
    ...
    return [...this.allWellPlans(tenantId), wellPlanId, '/planned/emissions/'];
  },

  wellPlanBaselineCO2Emissions({
    wellPlanId,
    tenantId,
  }: {
    tenantId: number;
    ...
    return [
      ...this.wellPlanPlannedEmissions({ wellPlanId, tenantId }),
      `/baseline/co2/`,
    ];
  },

  wellPlanTargetCO2Emissions({
    wellPlanId,
    tenantId,
  }: {
    tenantId: number;
