...
from apps.emissions.factories.wells import BaseCO2Factory, BaselineCO2Factory, TargetCO2Factory
...
from apps.emissions.models.wells import BaseCO2
...
def test_get_daily_co2_emissions(co2_factory: type[BaseCO2Factory], co2_model: type[BaseCO2]):
    ...
    emissions = get_daily_co2_emissions(well_planner=well_plan, co2_model=co2_model).values(
        'date',
        'total_asset',
