...
from apps.emissions.services.calculator.baseline import BaselineCO2Data, calculate_planned_step_baseline_co2
...
def test_calculate_planned_step_baseline_co2(step: WellPlannerPlannedStepFactory):
    assert calculate_planned_step_baseline_co2(
        ...
        # 'Well Planner'!E272
        plan_duration=20.58,
        # =SUM('Calculation'!E261;'Calculation'!E266)
        season_duration=11.025,
    ) == BaselineCO2Data(
        # 'Calculation'!E24
        asset=3128.3739375,
        # 'Calculation'!J315, but calculated with 'Calculation'!E261
        boilers=36.447075,
        # 'Calculation'!K315, but calculated with 'Calculation'!E261
        vessels=747.4543,
        # 'Calculation'!H124, but calculated with 'Calculation'!E261
        helicopters=14.921525892857144,
        # 'Calculation'!I159
        materials=545.0,
        # 'Calculation'!H289 but based on 'Calculation'!E261
