...
from apps.emissions.factories.wells import BaseCO2Factory, BaselineCO2Factory
from apps.emissions.models import CompleteHelicopterUse, PlannedHelicopterUse, WellName
from apps.emissions.models.wells import BaseCO2, BaselineCO2, TargetCO2
from apps.emissions.serializers import WellCO2EmissionSerializer, WellNameListSerializer
from apps.emissions.services import get_daily_co2_emissions
    ...
    def test_should_retrieve_co2_emissions(
        ...
        assert (
            ...
            == WellCO2EmissionSerializer(
                get_daily_co2_emissions(well_planner=well_plan, co2_model=co2_model), many=True
            ).data
        )
